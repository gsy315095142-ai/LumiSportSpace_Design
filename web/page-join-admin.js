        ...
        '<div class="illus-row">' +
          ...
          '<div class="desc-area">' +
            ...
            '<ul class="anno-list">' +
              ...
              '<li data-num="4"><strong>「开启竞猜」按钮</strong> — 双方选手通过审核后可点击；若实力悬殊系统会拒绝并提示原因</li>' +
              '<li data-num="5"><strong>「重新等待报名」按钮</strong> — 取消本局，退还全部竞猜币，局数 +1，退回等待报名阶段</li>' +
              '<li data-num="6"><strong>「立即开始比赛」按钮</strong> — 可跳过竞猜阶段直接开赛，适用于无需竞猜的场景</li>' +
            '</ul>' +
          '</div>' +
        '</div>' +
